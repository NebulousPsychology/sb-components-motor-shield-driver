...
pub struct MotorArray {
    pub motor1: SbcMotor1,
    pub motor2: SbcMotor2,
    pub motor3: SbcMotor3,
    pub motor4: SbcMotor4,
}

pub struct MotorShield {
    // pub sensor_ir1: sensor::SensorIR,
    // pub sensor_ir2: sensor::SensorIR,
    // pub sensor_sonic: sensor::Ultrasonic,
    // pub sensor_sonic_x: sensor::Ultrasonic,

    // pub light_left: impl rp_pico::hal::digital::OutputPin,
...
impl MotorShieldConfigurationBuilder {
    fn with_motor1(
        self,
    ...
    fn build(self) -> Result<MotorShield, MotorShieldError> {
