...
pub type PicoGeeekpiSbcShield = components::MotorShield<
...
pub fn create(
...
) -> Result<(PicoGeeekpiSbcShield, UnusedPins), components::MotorShieldError> {
    ...
    let pico_shield = components::MotorShieldConfigurationBuilder::new()
